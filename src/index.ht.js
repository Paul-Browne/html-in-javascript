...
html({lang: "en"},
    head(
        ...
        title("HT.JS - JavaScript to HTML"),
        meta({name:"description", content:"HT.JS is a library for easily creating JavaScript to HTML, for both the backend and the frontend."}),
    ...
    body(
        ...
        h3(a({href: "https://cdn.jsdelivr.net/npm/javascript-to-html/dist/index.js"}, "less than 3Kb"), ", with zero dependencies."),
...
&lt;/div&gt;`
        ...
        p("That's it... Congratulations! you are now an expert in HT.JS. You can now add it to your CV 😉"),
...
&lt;/section&gt;`
        ...
        p(
            ...
            "It can be used directly in the frontend (SPA style) in a build process to create static-sites (SSG), or even for server-side rendering (SSR)."
        ),
